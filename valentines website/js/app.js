...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "Ты хотела нажать Да 🤭";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "Попробуй ещё раз 🤗";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "Я сейчас заплачу 😭";
    yes.style.height = "80%";
    yes.style.width = "80%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Я так и знал 😄😍";
  yes.innerHTML = '<a href="https://t.me/doom_henker">Напиши, когда встречаемся</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
